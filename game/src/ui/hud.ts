...
export class HUD {
  ...
  private refreshStatic(): void {
    ...
    const tip = (id: string, key: string) => { const e = this.q(id); if (e) e.title = t(key); };
    tip("uc-builder", "hud.cntBuilder"); tip("uc-repair", "hud.cntRepair"); tip("uc-medic", "hud.cntMedic");
  }
  ...
  private panelHtml(own: ViewEntity[], builder: ViewEntity | undefined, prod: ViewEntity | undefined, research: ViewEntity | undefined): string {
    ...
    if (own.some((e) => e.kind === "building")) {
      ...
      if (b0.type === "radar") return this.radarPanelHtml(b0);
  ...
  private radarPanelHtml(b: ViewEntity): string {
