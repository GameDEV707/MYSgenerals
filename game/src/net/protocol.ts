...
export interface EntitySnap {
  ...
  rank: number;
  fl: number;           // bit flags: 1 constructing, 2 mining, 4 isVehicle, 8 hasWeapon, 16 hero, 32 stub(last-known), 64 busy(own: builder building / support healing), 128 hostileNeutral (T34 fortress + garrison → rendered white, two-way targetable)
...
export const FL = {
  constructing: 1, mining: 2, vehicle: 4, weapon: 8, hero: 16, stub: 32, busy: 64, hostile: 128,
} as const;
