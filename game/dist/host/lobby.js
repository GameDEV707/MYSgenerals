...
export class Lobby {
    ...
    setGameType(gt) {
        ...
        if (gt === "team") {
            this.state.slots.forEach((s, i) => { if (s.team === undefined)
                s.team = i % 2; });
        }
        this.changed();
    }
    ...
    setTeamColor(team, color) {
        ...
        if (this.state.teamColors[other] === color)
            return;
